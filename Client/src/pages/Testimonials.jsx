export default function Testimonials(){
    return(
<section id="Lovedby" className="px-5 w-full py-24 bg-gradient-to-b from-[#0b1220] to-black text-white">
  <div className="container mx-auto px-6 text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <div className="p-8 rounded-2xl bg-white/5 border border-white/10 shadow-xl backdrop-blur-xl">
        <p className="text-gray-200 mb-6">
          “The rotation engine is crazy accurate.  
          I use it for TikTok remixes — people LOVE it.”
        </p>
        <div className="flex items-center gap-3 justify-center">
          <img
            className="w-12 h-12 rounded-full"
      ...
      <div className="p-8 rounded-2xl bg-white/5 border border-white/10 shadow-xl backdrop-blur-xl">
        <p className="text-gray-200 mb-6">
          “Processed 12 tracks in minutes.  
          MP3 export is super fast. No login, no limits.”
        </p>
        <div className="flex items-center gap-3 justify-center">
          <img
            className="w-12 h-12 rounded-full"
