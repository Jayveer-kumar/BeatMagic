...
var _process8D = Module['_process8D'] = makeInvalidEarlyAccess('_process8D');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['process8D'] != 'undefined', 'missing Wasm export: process8D');
  ...
  _process8D = Module['_process8D'] = createExportWrapper('process8D', 4);
